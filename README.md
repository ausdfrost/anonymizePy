...
Once anonymizePy is installed, you can run '[example.py](https://github.com/ausdfrost/anonymizePy/blob/main/example.py)' to get an idea on how anonymizePy works!
